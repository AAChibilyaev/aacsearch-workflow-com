/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: bfc5fc4bacaaf08bd45317bd916e708c)
...
declare namespace Cloudflare {
	interface Env {
		...
		LAGO_API_URL: string;
		LAGO_API_KEY: string;
		LAGO_WEBHOOK_ISSUER: string;
		LAGO_WEBHOOK_HMAC_KEY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PAYLOAD_SECRET" | "LAGO_API_URL" | "LAGO_API_KEY" | "LAGO_WEBHOOK_ISSUER" | "LAGO_WEBHOOK_HMAC_KEY" | "LAGO_ORGANIZATION_ID" | "OPENAI_API_KEY">> {}
}
