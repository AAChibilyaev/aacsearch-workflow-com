...
import type { TenantOption } from './AnalyticsPanel'

import { AnalyticsPanel } from './AnalyticsPanel'
import { t } from './i18n'

/**
 * Custom admin view at /admin/analytics. Server component: resolves the
 * acting tenant (multi-tenant plugin cookie -> user membership -> first
 * option) and renders the client AnalyticsPanel, which reads the white-label
 * /api/search/analytics endpoint for that tenant.
 */
  ...
  return (
    ...
    >
      <Gutter>
        ...
        <AnalyticsPanel initialTenantId={initialTenantId} lang={lang} tenantOptions={tenantOptions} />
      </Gutter>
    </DefaultTemplate>
  )
}
